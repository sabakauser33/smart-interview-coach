...
const Interview = () => {
  ...
  const [pdfLoading, setPdfLoading] = useState(false); // ← ADD ON THIS LINE
  const { report, getReportById, getResumePdf, clearReport } = useInterview();
    ...
    <div className="interview-page">
      <div className="interview-layout">
        ...
        <nav className="interview-nav">
          ...
          <button
            onClick={async () => {
              clearReport(); // ← 1. clear stale report
              await handleLogout(); // ← 2. clear user + cookie
